...
export function renderFontPanelHtml(): string {
  ...
  <div class="grid">
    <div>
      ...
      <fieldset>
        <legend>Character coverage</legend>
        <div class="field">
        ...
        <p class="note">Client-side rasterization caps out at ${MAX_CODEPOINTS.toLocaleString()} combined codepoints to keep the browser responsive — large CJK blocks aren't practical here.</p>
      </fieldset>
      ...
      <fieldset>
        ...
        <p class="note">3bpp (compression-gated, matching the official tool) isn't implemented — LVGL's real compression algorithm isn't reproduced here.</p>
        <div class="row field">
          <div>
      ...
      <fieldset>
        ...
        <div class="actions">
          <button class="primary" id="font-convert-btn" disabled>Convert</button>
          <button class="secondary" id="font-download-btn" disabled>Download</button>
        </div>
